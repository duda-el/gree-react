...
export default function News() {
  return (
    <div className="w-full mt-10 px-8">
      <h2 className="text-4xl font-bold text-center text-blue-800 mb-8" style={{fontFamily: "tkt"}}>ბლოგი</h2>
      {/* <div className="w-100 h-1 bg-blue-800 mb-4"></div> */}
      <div className="gap-2 grid grid-cols-12">
        <div className="relative col-span-12 sm:col-span-4 h-[300px] bg-cover bg-center border border-gray-300" style={{ backgroundImage: "url('https://gree-bulgaria.com/wp-content/uploads/2022/02/smetki-klimatici-1.jpg')" }}>
        ...
        <div className="relative col-span-12 sm:col-span-4 h-[300px] bg-cover bg-center border border-gray-300" style={{ backgroundImage: "url('https://gree-bulgaria.com/wp-content/uploads/2021/12/thumb_850x480_5678.jpg')" }}>
          <div className="absolute z-10 bottom-0 flex-col items-start p-4 bg-black bg-opacity-50 backdrop-blur-md transition-all duration-300 hover:py-6 cursor-pointer">
        ...
        <div className="relative col-span-12 sm:col-span-4 h-[300px] bg-cover bg-center border border-gray-300" style={{ backgroundImage: "url('https://gree-bulgaria.com/wp-content/uploads/2023/12/gree-plus-instrukcii.jpg')" }}>
